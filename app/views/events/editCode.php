     ...
     -->
        <form action="<?php echo URLROOT ?>/events_dashboard/<?php echo $data["event_id"] ?>/discount_code/<?php echo $data["code_id"] ?>/edit" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="radio" <?php if ($data['type'] == 'percentage') echo "checked" ?> name="type" class="<?php echo (!empty($data['type_err'])) ? 'is-invalid' : ''; ?>" value='percentage' />
            ...
            <div class="form-group mb-4">
                ...
                <!-- all customers -->
                <input id="all-customer" type="radio" <?php if ($data['customer_eligibility'] == 'all') echo "checked" ?> name="customer_eligibility" class="<?php echo (!empty($data['customer_eligibility_err'])) ? 'is-invalid' : ''; ?>" value='all' />
                ...
                <!-- To search -->
                <div id="customer-search" class="input-group <?php if ($data['customer_eligibility'] == 'all') echo "hide" ?>">
            ...
            <div class="form-group mb-4">
                ...
                <input class="form-control" type="datetime-local" name="start_date" placeholder="Select Date and Time" value="<?php echo $data['start_date']; ?>"></input>
                ...
                <input class="form-control <?php if (!$data['end_date']) echo "hide" ?>" id="end-date-input" type="datetime-local" name="end_date" placeholder="Select Date and Time" value="<?php echo $data['end_date']; ?>"></input>
